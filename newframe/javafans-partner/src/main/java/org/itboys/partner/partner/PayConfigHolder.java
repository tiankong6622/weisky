...
public class PayConfigHolder {
	...
	private static final String ALIPAY_NOTIFY_URL = "alipayNotifyUrl";
	private static final String ALIPAY_RETURN_URL = "alipayReturnUrl";
	private static final String ALIPAY_WAP_NOTIFY_URL = "wapNotifyUrl";
	private static final String ALIPAY_WAP_RETURN_URL = "wapCallbackUrl";
	private static final String ALIPAY_SELLER_EMAIL = "alipaySellerEmail";
	private static final String ALIPAY_WAP_VERSION = "wapVersion";
	...
	public static String getAlipayWapCallbackUrl(){
		return configMap.get(ALIPAY_WAP_RETURN_URL);
	}
	...
	public static String getAlipayWapNotifyUrl(){
		return configMap.get(ALIPAY_WAP_NOTIFY_URL);
	}
	...
	public static String getAlipayWapVersion(){
		return configMap.get(ALIPAY_WAP_VERSION);
	}
