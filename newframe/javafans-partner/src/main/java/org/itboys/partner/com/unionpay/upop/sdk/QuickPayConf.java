package org.itboys.partner.com.unionpay.upop.sdk;

import org.itboys.partner.partner.unionpay.UnionPayConfig;
...
public class QuickPayConf {
	...
	/* 前台交易生产环境 */
	private final static String UPOP_BASE_URL = UnionPayConfig.getValue("UPOP_BASE_URL"); //  "https://unionpaysecure.com/api/";
	...
	/* 后台交易生产环境 */
	private final static String UPOP_BSPAY_BASE_URL = UnionPayConfig.getValue("UPOP_BSPAY_BASE_URL"); //"https://besvr.unionpaysecure.com/api/";
 ...
 //	private final static String UPOP_QUERY_BASE_URL = "https://www.epay.lxdns.com/UpopWeb/api/";
	...
	/* 查询交易生产环境 */
	private final static String UPOP_QUERY_BASE_URL = UnionPayConfig.getValue("UPOP_QUERY_BASE_URL"); //"https://query.unionpaysecure.com/api/";
	...
	// 商户代码
	public final static String merCode = UnionPayConfig.getValue("merCode"); //"103330155330002";

	// 商户名称
	public final static String merName = UnionPayConfig.getValue("merName"); //"富阳铁甲汽车用品有限公司";

	public final static String merFrontEndUrl = UnionPayConfig.getValue("merFrontEndUrl") ; //"http://www.portal.com:6900/payFrontResServlet";

	public final static String merBackEndUrl = UnionPayConfig.getValue("merBackEndUrl") ; //"http://www.portal.com:6900/payBackResServlet";
	...
	public final static String securityKey  = UnionPayConfig.getValue("securityKey"); //"88888888";
