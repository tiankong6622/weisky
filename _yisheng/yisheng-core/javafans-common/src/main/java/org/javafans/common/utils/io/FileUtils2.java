...
public class FileUtils2 {
	...
	private final static Logger logger = LoggerFactory.getLogger(FileUtils2.class);
	...
	public static void main(String args[]) {
		...
		System.out.println(FileUtils2.getFileName("aaaa.jpg", "2011","10"));
		System.out.println(FileUtils2.changeToWebRoot(FileUtils2.getFileName("aaaa.jpg", "2011","10"), "d:/sdfsdf"));
	}
	...
	public static String saveFile(InputStream stream,String saveImageDir,String fileName, String fileContentType){
		try{
			String realPath = FileUtils2.getFileName(fileName, String.valueOf(TimeUtils.getCurrentYear()), String.valueOf(TimeUtils.getCurrentMonth()));
	...
	public static String saveFile(File file,String fileName,String saveFileDir, String fileContentType){
		try{
			...
			return FileUtils2.saveFile(stream,saveFileDir, fileName, fileContentType);
		}catch(Exception e){
			throw new RuntimeException(e);
		}
	}
	...
	public static String saveImage(InputStream stream,String saveImageDir,String fileName, String fileContentType,
		...
		try {
			...
			String realPath = FileUtils2.getFileName(fileName, String
	...
	public static String saveImage(File file,String savedDir,String fileName,String fileContentType){
		return FileUtils2.saveImage(file, savedDir,fileName, fileContentType, 0, 0);
	}
	
	public static String saveImage(InputStream stream,String savedDir,String fileName,String fileContentType){
		return FileUtils2.saveImage(stream, savedDir,fileName, fileContentType, 0, 0);
	}
}
