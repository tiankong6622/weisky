...
public class TimeUtils {
	...
	*/
	...
	public static Date getYearFirstDay(){
		Calendar calendar = Calendar.getInstance();
		calendar.setTime(new Date());
		return getDate(calendar.get(Calendar.YEAR), 1,1);
	}
	...
	public static Date getMonthFirstDay(){
		...
		return getDate(calendar.get(Calendar.YEAR),calendar.get(Calendar.MONTH) + 1,1);
	}
	/**
	 * 获得某一周的第一天
	 * @return
	 */
	public static java.sql.Date getFirstDayOfWeek(){
		Calendar calendar = Calendar.getInstance();
		calendar.setTime(new Date());
	...
	/**
	  ...
	  /**   
	    ...
	    public static String getRemainder(){
			...
			return time+rightNow.get(Calendar.HOUR)+":"+rightNow.get(Calendar.MINUTE);
		}
