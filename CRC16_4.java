package com.hz.sunday.yangman.crc;

public class CRC16_4 {

	 public static void main(String[] args) {
		 	//00000001000AAAA1A2A30104A1100720
		 int result=CRC16_4.GetCrc16(new int[]{0x3E, 0x44, 0x41,
				 0x00,0x00,0x00,0x01,0x00,0x0A,0xAA,0xA1,0xA2,0xA3,0x01,0x04,0xA1,0x10,0x07,0x20});
	     ...
	     * @return CRC值
	     */
	    public static int GetCrc16(int[] data) { // 初始化
	        int High = 0xFF; // 高字节
	        int Low = 0xFF; // 低字节
	        if (data != null) {
	            for (int b : data) {
